...
namespace Admin.Web.Areas.Administrator.Controllers
{
    public class ProductCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Alias,Description,DisplayOrder,Status,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy")] ProductCategory productCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Alias,Description,DisplayOrder,Status,CreatedDate,CreatedBy,UpdatedDate,UpdatedBy")] ProductCategory productCategory)
        {
            if (ModelState.IsValid)
            {
